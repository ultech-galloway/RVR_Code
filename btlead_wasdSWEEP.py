'''
btlead_wasdSWEEP.py - Drive leader with WASD keys via SSH/VNC.
Follower RVRs mirror leader's movements in real time with formation sweeps.
...
D - Turn Right
Spacebar - Stop
1 - Sweep Left (formation scaling)
2 - Sweep Right (formation scaling)
Q - Quit

LAST: Dr. A (05.07.26) - Added sweep formation logic
'''
...
def main():
    ...
    global running, is_sweeping
    
    try:
        print("=== LEADER RVR - WASD CONTROL WITH SWEEPS ===")
        ...
        print("\n=== WASD CONTROL ACTIVE ===")
        print("W=Forward | A=Left | S=Reverse | D=Right | Space=Stop")
        print("1=Sweep Left | 2=Sweep Right | Q=Quit\n")
        ...
        while running:
            ...
            elif current_key_code == 49:  # 1 - Sweep Left
                heading = (heading - 10) % 360
                speed = 128
                flags = 0
                is_sweeping = True
                print(f"Sweep Left: heading={heading}, speed={speed}")
                
            elif current_key_code == 50:  # 2 - Sweep Right
                heading = (heading + 10) % 360
                speed = 128
                flags = 0
                is_sweeping = True
                print(f"Sweep Right: heading={heading}, speed={speed}")
